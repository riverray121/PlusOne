...
iOS app that blocks selected social media apps until a live selfie shows at
least two faces, granting a 5-minute unlock window.
...
- XcodeGen — project generation from `project.yml`; the `.xcodeproj` is not committed
