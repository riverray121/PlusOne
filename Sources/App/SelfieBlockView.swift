    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("Duration is minutes of usage granted per selfie pass and applies to the next session. Cooldown is the wait required between sessions. The cap is the maximum sessions per day.")
            }
